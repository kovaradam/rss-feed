...
export default function Welcome() {
  ...
  return (
    <main className="relative flex h-[200vh] min-h-screen flex-col-reverse justify-center bg-white dark:bg-slate-900 sm:h-screen sm:flex-row sm:justify-start ">
      <section className="flex h-screen flex-col items-center justify-between bg-blue-100 p-[5%] dark:bg-slate-950 sm:h-full sm:w-1/3">
        <div className="flex flex-col gap-4">
          <p className="text-4xl font-bold text-blue-900 dark:text-slate-400">
